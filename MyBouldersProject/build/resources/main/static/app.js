...
contactForm.addEventListener("submit", function (e) {
    ...
    // Effectuez une requête POST vers votre backend Java
    fetch("/addContact", {
        method: "POST",
        headers: {
        ...
        .then(response => response.json()) // Vous pouvez analyser la réponse JSON de votre backend ici si nécessaire
        .then(data => {
            // Vous pouvez effectuer des actions supplémentaires ici après l'enregistrement des données
